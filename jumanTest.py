...
path_to_chromedriver = '/usr/local/Cellar/chromedriver'            # change path as needed
#os.environ["webdriver.chrome.driver"] = path_to_chromedriver
browser = webdriver.Chrome(executable_path = path_to_chromedriver)


url = input('https://twitter.com/search?l=ja&q=%E7%94%B1%E5%A4%A2%20since%3A2017-09-01%20until%3A2017-09-02&src=typd') + '/'
